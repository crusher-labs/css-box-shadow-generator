...
Create, preview, and copy CSS box-shadow styles in real time.

Live: <https://crusher-labs.github.io/css-box-shadow-generator/>
...
- Or serve the parent workspace via the hub's preview server: `cd ../../tools-hub && npm run preview` then visit `http://127.0.0.1:8723/utility-tools/css-box-shadow-generator/`.
